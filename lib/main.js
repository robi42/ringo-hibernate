...
addToClasspath(module.resolve('../jars/antlr-2.7.6.jar'));
addToClasspath(module.resolve('../jars/backport-util-concurrent-Java50-3.1.jar'));
addToClasspath(module.resolve('../jars/c3p0-0.9.1.jar'));
addToClasspath(module.resolve('../jars/commons-collections-3.1.jar'));
addToClasspath(module.resolve('../jars/commons-logging-1.1.1.jar'));
addToClasspath(module.resolve('../jars/dom4j-1.6.1.jar'));
addToClasspath(module.resolve('../jars/ehcache-1.5.0.jar'));
addToClasspath(module.resolve('../jars/hibernate3.jar'));
addToClasspath(module.resolve('../jars/javassist-3.9.0.GA.jar'));
addToClasspath(module.resolve('../jars/jsr107cache-1.1.jar'));
addToClasspath(module.resolve('../jars/jta-1.1.jar'));
addToClasspath(module.resolve('../jars/hsqldb-1.8.1.2.jar'));
        ...
        if (registry[entityName].mapping) {
            ...
            for (let propName in props) {
                if (typeof props[propName] === 'string') {
                    props[propName] = {type: props[propName]};
                }
...
function BaseQuery(type) {
    ...
    this.orderBy = function (expression) {
        /^-.+$/i.test(expression) ?
                query.addOrder(ORDER_BY_DESC(expression.substring(1))) :
